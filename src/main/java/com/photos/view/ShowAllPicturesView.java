...
@Secured({"admin", "user"})
@Route(value = ShowAllPicturesView.ROUTE)
public class ShowAllPicturesView extends MenuView {

    public static final String ROUTE = "show_all";
    ...
    public ShowAllPicturesView(PictureService pictureService) {
    ...
    private void createTextLabel() {
        Label textLabel = new Label("Zdjęcia wszystkich użytkowników");
        textLabel.setClassName("description-styles");
